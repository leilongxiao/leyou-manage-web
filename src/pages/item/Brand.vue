  ...
  export default {
    ...
    data() {
      return {
        ...
        pagination: {}, // 分页信息
        headers: [
          {text: 'id', align: 'center', value: 'id'},//value对应数据库表列名，text为网页山显示的名称。
    ...
    watch: {
      pagination: { // 监视pagination属性的变化
        deep: true, // deep为true，会监视pagination的属性及属性中的对象属性变化(不加只会监控本身的属性变换？)
        handler() {
    ...
    methods: {
      getDataFromServer() { // 从服务的加载数的方法。
        // 发起请求，这里的$http在http.js中中是封装了axios的
